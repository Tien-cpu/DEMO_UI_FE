...
function MySuorcePage(props) {
	...
	return (
		<main className={classes.main}>
						...
						<div class="row">
							...
							<div class="col-xs-10 text-right menu-1">
								<ul>
									...
									<li class="active"><a href="/MySuorcePage">Courses</a></li>
			...
			<div class="content">
				<div class="container">
				<h2 class="mb-5">My Courses For Study</h2>
				<div class="table-responsive">
					...
					<tbody>
						<tr scope="row">
							<td>1392</td>
							<td>CHÍNH SÁCH THƯƠNG MẠI VIETJET</td>
							<td>1/14/2022 9:56:35 PM</td>
							<td>2/14/2022 10:35:46 AM</td>
							<td>2/14/2022 10:35:46 AM</td>
							<td>0.00</td>
							<td>Launch this Course</td>
						</tr>
						<tr>
							<td>4616</td>
...
export default withStyles(styles)(MySuorcePage)